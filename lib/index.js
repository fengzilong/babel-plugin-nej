	...
	return {
		...
		visitor: {
			CallExpression: function CallExpression(path) {
				...
				if ((callee.name === 'define' || callee.type === 'MemberExpression' && callee.object.type === 'Identifier' && callee.object.name === 'NEJ' && callee.property.type === 'Identifier' && callee.property.name === 'define') && args.length === 2 && args && args[0].type === 'ArrayExpression' && args[1].type === 'FunctionExpression') {
					(function () {
